...
3. true
        ...
        System.out.println(number += 3); //10 number + 3 의 결과물
                                         // number에 할당 (number = number + 3)
        ...
        System.out.println(false && true && true || false && true); // false
...
//       1. System.out.println(3 > 2 && 1 == 1);
//       2. System.out.println(1 != 1);
//       3. System.out.println(3>=3 || 11<11 && !bool2);
        ...
        System.out.println(result);  // 이으아아아
