...
public class A_If {
    public static void main(String[] args) {
        ...
        if (age > 19) {
            System.out.println("성인 입니다"); // X
        } else {
            System.out.println("미성년자 입니다."); // O
        }
        ...
        if (age > 19) {
            ...
            System.out.println("청소년"); // O
        } else {
            System.out.println(" 어린이"); // X
        }

        //예제 3) 나이 분류 (중괄호 생략
        //: 조건문에서 실행될 코드 블럭({})에 코드가 하나의 구문인 경우 {} 생략 가능

        if (age > 19) System.out.println( "성성인" ); // X
        else if (age > 13) System.out.println( "청청소년" ); // O
        else System.out.println( "어어린이" ); // X
