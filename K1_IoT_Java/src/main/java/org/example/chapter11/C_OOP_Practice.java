...
/*  === SOLID 원칙 ===
    ...
    ISP: 인터페이스 분리 원칙 - 자신이 서용하지 않는 인터페이스에 의존하지 않음
...
class CreditCardPaymentProcessor implements PaymentProcessor {
    ...
    public void processPayment(Order order) {
        System.out.println("신용카드로 결제 합니다: " + order.getOrderId());
    }
}
...
public class C_OOP_Practice {
    public static void main(String[] args) {
        ...
        PaymentProcessor samsumgPayPaymentProcessor = new SamsungPayPaymentProcessor();
        ...
        OrderService orderService2 = new OrderService(samsumgPayPaymentProcessor, generateReport);
