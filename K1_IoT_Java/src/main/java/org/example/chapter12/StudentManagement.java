...
public class StudentManagement {
    public static void main(String[] args) {
        ...
        dummyStudents.add(new Student(1, "이승승", 25, "1111"));
        dummyStudents.add(new Student(1, "이도도", 29, "2222"));
        dummyStudents.add(new Student(1, "조승승", 30, "1234"));
        dummyStudents.add(new Student(1, "김명명", 32, "5678"));
