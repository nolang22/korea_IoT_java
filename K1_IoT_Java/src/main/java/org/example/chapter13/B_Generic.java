...
/*  === 제네릭 와일드 카드 === //
    ...
    - 주호 '상속관계'에 있는 클래스 간의 유연한 타입 처리를 위해 사용
    >> 물음표(?) 기호를 사용 하여 표기
        : 타입이 무엇이든 상관없을 의미
 */
class Message<T> {
...
public class B_Generic {
    public static void main(String[] args) {
         ...
         */
        Message<?> m1; //Message<Object> m1 // 모든 타입의 Message 객체를 수용
        Message<String> m2;

        /*  형 변환: Object 클래스는 모든 탐조 타입의 최상위 클래스
                - 모든 타입 클래스와 상속 관계
         */
        m1 = new Message<>();
        ...
        // : Number의 자손 타입 중 하나이긴 하나, 장확히 어떤 타입인지 확인 불가!
        // >> 읽기는 가능!, 쓰기는 제한!
        ...
        // integerList.add(123.345); // Double
