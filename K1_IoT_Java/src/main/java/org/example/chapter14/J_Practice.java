...
public class J_Practice {
    public static void main(String[] args) {
        List<StudentClass> studentClasses = Arrays.asList(
                new StudentClass("오신신", 25, 4.3),
                new StudentClass("김세세", 30, 4.5),
                new StudentClass("권민민", 27, 4.0),
                new StudentClass("안미미", 29, 3.8),
                new StudentClass("김태태", 20, 3.9)
        );
