...
public class B_Enum {
    public static void main(String[] args) {
        ...
        FruitsClass fruits = new FruitsClass("이승승");
        System.out.println(fruits); // FruitsClass(name=이승승)

        // == ENUM의 주료 메서드 ==
        // 1) values(): 열거형의 모든 값을 배열로 반환
        System.out.println(Fruits.values()); // 배열릐 주소값 - [Lorg.example.chapter16.Fruits;@27d6c5e0
